...
# This script checks for the existence of the 'ovp' registry key.
...
# Check if 'ovp' registry value exists
$ovpValue = Get-ItemProperty -Path $regPath -Name "ovp" -ErrorAction SilentlyContinue
